...
using IceCreamParlour.Data.interfaces;


namespace IceCreamParlour.Implementation
{
    public class DataAccess<TEntity> : IDataAccess<TEntity> where TEntity : class
    {
        ...
        /// The context
        /// </summary>
        internal IceCreamDbContext context;
        ...
        public DataAccess(IceCreamDbContext context)
        {
